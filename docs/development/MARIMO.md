...
|---|---|
| `boring.py` | Identifies "boring" baby names with uniform distributions over time |
| `elvis.py` | Baby name analysis |
| `geometry.py` | Baby name geometry analysis |
| `old.py` | Legacy notebook |
...
```bash
marimo edit book/marimo/notebooks/boring.py
```
...
```bash
uv run book/marimo/notebooks/boring.py
```
